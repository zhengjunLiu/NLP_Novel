...
f = open('./代词统计/成功小说.csv', 'a+')
writer = csv.writer(f)
writer.writerow(["排名","词语","成功","不成功"])
def dictionarylist():
    T=[]
...
def corpus_segment2(corpus_path):
    ...
    return G.most_common(150)


if __name__ == "__main__":
    S_word_lst = corpus_segment2("./NLP_Pos/不成功词与词性/")
    F_word_lst = corpus_segment2("./NLP_Pos/成功词与词性/")
    dic = dictionarylist()
